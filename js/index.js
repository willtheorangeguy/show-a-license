...
})()(
  {
    1: [
      function (require, module, exports) {
        ...
        searchLicenseEl.addEventListener(
        ...
        viewExplanationsEl.addEventListener("click", function (e) {
          ...
          Url.updateSearchParam(
            "hide_explanations",
            showExplanations ? "true" : undefined,
          );
          location.reload();
        });
        ...
        function getLicense(license, fn) {
          sameTime(
            [
              doRequest(
                "https://ionicabizau.github.io/show-a-license/licenses/" +
                  license +
                  ".txt",
              ),
              doRequest(
                "https://ionicabizau.github.io/show-a-license/explanations/" +
                  license +
                  ".txt",
              ),
            ],
        ...
        function showError(err) {
          ...
          if (err.code === 404) {
            sweetErr.text =
              "Cannot find such a licence. Feel free to <a href='https://github.com/IonicaBizau/show-a-license#adding-a-new-license'>add it</a>.";
            location.hash = "";
          } else if (err.code === "EXPLANATION_DOES_NOT_EXIST") {
            sweetErr.type = "warning";
            sweetErr.text =
              "This license doesn't have any explanation. Feel free to <a href='https://github.com/IonicaBizau/show-a-license#explaining-a-license'>add it</a>.";
          }
        ...
        function renderLicense(err, data) {
          ...
          if (showExplanations) {
            if (!data.explanation.join("")) {
              showError(
                new Err(
                  "Explanation doesn't exist. You can add it ",
                  "EXPLANATION_DOES_NOT_EXIST",
                ),
              );
          ...
          data.license.forEach(function (c, i) {
            ...
            if (showExplanations) {
              html +=
                "<td class='explanation'>" + data.explanation[i] + "</td>";
            }
    ...
    2: [
      ...
      { "iterate-object": 8, "regex-escape": 11, typpy: 13 },
    ],
    3: [
      function (require, module, exports) {
        "use strict";
          ...
          if (typeof elm === "string") {
            ...
            parent =
              typeof parent === "string"
                ? elmSelect(parent, null, null, document)[0]
                : parent;
    ...
    6: [
        ...
        module.exports = (function (_Error) {
          ...
          function Err(error, code, data) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (Err.__proto__ || Object.getPrototypeOf(Err)).call(this, error),
            );
      ...
      { barbe: 2, "iterate-object": 8, typpy: 13 },
    ],
    7: [
      function (require, module, exports) {
        "use strict";
