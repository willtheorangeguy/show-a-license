...
function getLicense(license, fn) {
    sameTime([
        doRequest("https://ionicabizau.github.io/show-a-license/licenses/" + license + ".txt")
      , doRequest("https://ionicabizau.github.io/show-a-license/explanations/" + license + ".txt")
    ], function (err, data) {
